...
<style type="text/css">
.enroll {
	background-image: url("images/kits.jpg");
...
.view {
	background-image: url("images/pexels1.jpeg");
	background-size: cover;
	background-repeat: no-repeat;
}
</style>
									...
									<div class="row">
										...
										<div class="col">
											<select class="select form-control-sm" name="batchNumber">
												...
												<option value="FDJ-164">FDJ-174</option>
												<option value="REG-164">REG-174</option>
												<option value="FDJ-165">FDJ-175</option>
												<option value="REG-165">REG-175</option>
